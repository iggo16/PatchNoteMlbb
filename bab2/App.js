...
import { fontType, colors } from './src/assets/fonts/theme';

export default function App() {
  return (
    <ImageBackground source={{ uri: 'https://static.wikia.nocookie.net/mobile-legends/images/e/e6/Site-logo.png/revision/latest?cb=20211110152908' }} style={styles.container}>
      <View style={styles.overlay}>
        <View style={styles.header}>
          <Image source={{ uri: 'https://i.pinimg.com/564x/59/81/ea/5981eada09c0ccdb38d9c7366960e9fb.jpg' }} style={styles.logoImage} />
